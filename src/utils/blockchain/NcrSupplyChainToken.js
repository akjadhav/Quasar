...
NRCSupplyChainToken.addNewBlock(new CryptoBlock(1, "01/20/2020", {
    sender: "XYZ Manufacturing",
    recipient: "NCR API Mart",
    quantity: 1
}));
NRCSupplyChainToken.addNewBlock(new CryptoBlock(2, "02/05/2020", {
    sender: "ABC Assembly",
    recipient: "NCR API Mart",
    quantity: 1
}));
NRCSupplyChainToken.addNewBlock(new CryptoBlock(3, "02/17/2020", {
    sender: "IJK Distribution",
    recipient: "NCR API Mart",
    quantity: 1
}));
NRCSupplyChainToken.addNewBlock(new CryptoBlock(4, "02/28/2020", {
