...
<div>
    ...
    <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="text-6xl font-extrabold tracking-tight text-center my-24 text-gray-900">CART</h2>
        ...
        <div className="mt-20">
            <button
                className="inline-block bg-green-600 py-2 w-full px-24 border border-transparent rounded-md text-base font-medium text-white hover:bg-green-400"
                >
                Chcckout
            </button>
        </div>
